          ...
          <div className="flex justify-center mb-6">
            <div className="inline-flex rounded-md shadow-sm" role="group">
              <button
                ...
                className="px-4 py-2 text-sm font-medium rounded-l-lg bg-white text-gray-700 hover:bg-gray-50"
              >
                Donor
              </button>
              ...
              <button
                ...
                className="px-4 py-2 text-sm font-medium rounded-r-lg bg-red-600 text-white"
              >
                Hospital
              </button>
            </div>
          ...
          <div className="mt-6">
            ...
            <div className="mt-6">
              <Button
                variant="secondary"
                fullWidth
                onClick={() => navigate(`/signup?type=hospital`)}
              >
